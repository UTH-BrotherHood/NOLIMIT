...
import { loggedInUserData, Message, UserData } from '@/app/dashboard/message/data'
...
export default function ChatBottombar({ isMobile, sendMessage, selectedUser }: ChatBottombarProps) {
