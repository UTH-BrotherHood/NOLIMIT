...
export default function Banner() {
  return (
    <div className='flex flex-col justify-center items-center pt-10 lg:pt-24 xl:pt-32 gap-8 select-none'>
      ...
      <Link
        href={'/dashboard'}
        className='hidden lg:block font-semibold py-2 px-8 rounded-lg text-white bg-primary hover:opacity-80'
      >
        Try It Now
      </Link>
      <Button
